...
BubbleBottomBarItem tab(String tabName, IconData icon, IconData iconActive) {
  return BubbleBottomBarItem(
      backgroundColor: AppConfigs.appPrimaryColor,
      icon: Icon(
        icon,
        size: 24.0,
      ...
      title: AutoSizeText(tabName, maxLines: 1));
}
